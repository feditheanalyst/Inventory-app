...
if selected == "Data Entry":
    ...
    with st.form(key='my_form'):    
        ...
        if submitted:
            sql = "insert into dataas(customer_id, customer_email, customer_phone, product_name, product_description, initial_price, amount_sold, discount, stock_quantity, order_id, order_date, state, country, payment_method) values(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
    ...
    cursor.execute("select * from dataas")
    ...
    AverageSales = df1["amount_sold"].mean()
